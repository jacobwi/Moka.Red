...
///     Renders nothing while <see cref="Count" /> is zero.
...
{
	/// <summary>Number of selected items. The bar renders only when greater than zero.</summary>
	[Parameter]
	public int Count { get; set; }

	/// <summary>Text shown after the count, also used as the toolbar's accessible label. Defaults to "selected".</summary>
	[Parameter]
