...
| `Distance` | `string` | `"20px"` | Slide distance (any CSS length) |
...
```blazor-preview
<MokaFadeIn>
    <MokaCallout Type="MokaCalloutType.Note" Title="Welcome">
...
<MokaFlexbox Direction="MokaDirection.Column" Gap="MokaSpacingScale.Sm">
    <MokaFadeIn Direction="MokaFadeDirection.Up" Delay="0">
        <MokaCallout Type="MokaCalloutType.Tip" Title="Step 1">First item appears immediately.</MokaCallout>
    </MokaFadeIn>
    <MokaFadeIn Direction="MokaFadeDirection.Up" Delay="200">
        <MokaCallout Type="MokaCalloutType.Note" Title="Step 2">Second item follows after 200ms.</MokaCallout>
    </MokaFadeIn>
